...
1. Add to wwwroot a .gitattributes file that says "* binary". This tells GitHub not to modify line endings since that causes "Failed to find a valid digest in the 'integrity' attribute" errors when you run the app on GitHub.
